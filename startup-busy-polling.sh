...
${CRE} exec vpp1 bash -c "echo 2 >> /sys/class/net/$interface/napi_defer_hard_irqs"
${CRE} exec vpp1 bash -c "echo 200000 >> /sys/class/net/$interface/gro_flush_timeout"

echo "=========== Jump into vpp1 ==========="
${CRE} exec -ti vpp1 ./build-root/install-vpp-native/vpp/bin/vpp -c VPP_STARTUP_BUSY_POLL.conf
